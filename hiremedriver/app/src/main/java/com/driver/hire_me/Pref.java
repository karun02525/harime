...
//    public String TRIP_PAY_AMOUNT="trip_pay_amount";
    ...
    public String TRIP_DURATION_VALUE_CHANGABLE = "duration_value";
...
*/
    ...
    public void setTRIP_DURATIONVALUE_CHANGABLE(String duration_changable) {
        edit().putString(TRIP_DURATION_VALUE_CHANGABLE, duration_changable).commit();
    }

    public String getTRIP_DURATION_VALUE_CHANGABLE() {
        return sharedPreferences.getString(TRIP_DURATION_VALUE_CHANGABLE, null);
    }
}
