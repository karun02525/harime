...
public class FareReviewActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentTripModel != null) {
            ...
            CircleImageView thumbNail = (CircleImageView) findViewById(R.id.icon);
            Picasso.with(FareReviewActivity.this).load(Constants.IMAGE_BASE_URL +  currentTripModel.user.getUProfileImagePath()).error(R.drawable.circleuser).into(thumbNail);
            ...
            try {
                distance.setText(controller.checkDistanceUnit().equalsIgnoreCase("km")?String.format("%.02f km", (Float.parseFloat(currentTripModel.trip.getTrip_distance().trim()) )):String.format("%.02f mi", (Float.parseFloat(currentTripModel.trip.getTrip_distance().trim())*0.621371)));
            ...
            try {
                ...
                distance.setText(controller.checkDistanceUnit().equalsIgnoreCase("km")?String.format("%.02f km", (Float.parseFloat(controller.pref.getTRIP_DISTANCE()) )):String.format("%.02f mi", (Float.parseFloat(controller.pref.getTRIP_DISTANCE())*0.621371)));
            } catch (Exception e) {
                distance.setText("");
            }
