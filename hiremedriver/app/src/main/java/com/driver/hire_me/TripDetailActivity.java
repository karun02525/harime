        ...
        try {
            ...
            try {
               ...
               //disty.setText(String.format("%.02f km", (Float.parseFloat(distance.trim()) / 1600.0) * 1000));
                disty.setText(controller.checkDistanceUnit().equalsIgnoreCase("km")?String.format("%.02f km", (Float.parseFloat(distance.trim()) )):String.format("%.02f mi", (Float.parseFloat(distance.trim())*0.621371)));
            } catch (Exception e) {
                e.printStackTrace();
                amounty.setText("");
                disty.setText("");
