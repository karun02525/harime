...
//
    ...
    public void setFareDetail(final TripHistory currentTrip) {
        ...
        distance.setText(String.format(controller.checkDistanceUnit().equalsIgnoreCase("km")?String.format("%.02f km", (Float.parseFloat(currentTrip.getTripDistance().trim()) )):String.format("%.02f mi", (Float.parseFloat(currentTrip.getTripDistance().trim())*0.621371))));
