...
public class TripDetailActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(i.getStringExtra("trip_status").equals("driver_cancel_at_pickup")||i.getStringExtra("trip_status").equals("driver_cancel_at_drop") || i.getStringExtra("trip_status").equals("cancel") )
        {
        ...
        Glide.with(this)
                .load(Constants.Urls.IMAGE_BASE_URL + i.getStringExtra("user_image"))
     ...
     /*       Date date_formet = dateFormat.parse(date.trim());
        ...
        namy.setText(name);
        amounty.setText(String.format(Locale.ENGLISH,controller.currencyUnit()+"%.02f", Float.parseFloat(amount.trim())));
        picky.setText(drop);
        dropy.setText(pickup);
        // disty.setText(String.format("%.02f km", (Float.parseFloat(distance.trim()) / 1600.0) * 1000));
        disty.setText(String.format(Locale.ENGLISH,controller.checkDistanceUnit().equalsIgnoreCase("km")?String.format(Locale.ENGLISH,"%.02f km", (Float.parseFloat(distance.trim()) )):String.format("%.02f mi", (Float.parseFloat(distance.trim())*0.621371))));
        promoAmounty.setText("-"+String.format(Locale.ENGLISH,controller.currencyUnit()+"%.02f", Float.parseFloat(promoAmount.trim())));
        taxAmount.setText(String.format(Locale.ENGLISH,controller.currencyUnit()+"%.02f", Float.parseFloat(tax.trim())));
        ...
        totalAmount.setText(String.format(Locale.ENGLISH,controller.currencyUnit()+"%.02f", Float.parseFloat(String.valueOf(grandTotal))));
