...
/*
    ...
    public void joinButtonClicked(View view) {
        ...
        final String f_name_ = f_name.getText().toString();
        final String l_name_ = l_name.getText().toString();
        final String email_ = email.getText().toString();
        final String mobileNo_ = mobileNo.getText().toString();
        ...
        if (f_name_.length() == 0) {
            ...
            Toast.makeText(getApplicationContext(), getResources().getString(R.string.email), Toast.LENGTH_LONG).show();
            email.requestFocus();
        ...
        }else if (password_.length() <=6 || password_.length() >=12) {
            Toast.makeText(getApplicationContext(), getResources().getString(R.string.passwords), Toast.LENGTH_LONG).show();
            password.requestFocus();
        }else {
            ...
            params.put("u_fname", f_name_);
            params.put("u_lname",l_name_);
            params.put("u_email", email_);
            params.put("u_phone", mobileNo_);
            params.put("u_password", password_);
