...
public class ProfileActivity extends Activity implements AppBarLayout.OnOffsetChangedListener{
	...
	EditText fname,lname,email,mob,password,payemail;
	  				        ...
	  				        System.out.print("Insite the Profile Activity Profile image"+profile_userprofilepic);
								...
								//	profileimagezoom.setImageBitmap(bitmap);
									...
									//profileimagezoom.setClickable(false);
	  				                 ...
	  				                 Toast.makeText(getApplicationContext(), R.string.invalid_userId, Toast.LENGTH_LONG).show();
