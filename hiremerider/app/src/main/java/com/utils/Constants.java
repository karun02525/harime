...
public interface Constants {
    public interface Urls {
        ...
        String URL_USER_SEND_NOTIFICATION_ANDROID1 = "http://appicial.com/HireTaxi/1.0.1/push/DriverAndroidPushNotification.php";
        // String URL_DRIVER_NOTIFICATION = "http://35.160.185.249/HireTaxi/push/DriverAndroidIosPushNotification.php";
        String URL_DRIVER_NOTIFICATION = "http://appicial.com/HireTaxi/push/DriverAndroidIosPushNotification.php";

        String URL_USER_SEND_NOTIFICATION_IOS1 = "http://appicial.com/HireTaxi/push/DriverPushNotification.php";
        ...
        String URL_VAAIDATE_PROMO = "http://appicial.com/HireTaxi/1.0.1/index.php/promoapi/validatepromos";
